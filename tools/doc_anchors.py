...
ANCHORS = [
    ...
    ("rm-cand-2-s7", RM, r"^\| ② \| \*\*G-P1-4", 96),
    ("rm-cand-3-i18n", RM, r"^\| ③ \| \*\*G-P1-5", 97),
    ("rm-cand-4-sdk", RM, r"^\| ④ \| G-P1-7", 98),
    ("rm-cand-5-mes", RM, r"^\| ⑤ \| G-P1-12", 99),
    ("rm-cand-dl-training", RM, r"^\| —— \| \*\*G-P1-3 DL", 100),
    ("rm-cand-p2-bundle", RM, r"^\| —— \| \*\*P2 全部", 101),
    ("rm-real4-heading", RM, r"^> ### .*「真机四项」定义", 103),
    ("rm-real4-unconfirmed", RM, r"定义提议，尚未由需求方确认", 105),
    ("rm-real4-row-camera", RM, r"^> \| 1 \| 相机真机联调", 109),
    ("rm-real4-row-plc", RM, r"^> \| 2 \| PLC 真机联动", 110),
    ("rm-real4-row-soak", RM, r"^> \| 3 \| 现场 7×24 长稳", 111),
    ("rm-real4-row-ac", RM, r"^> \| 4 \| AC1–AC8 现场验收", 112),
    ("rm-observation-item", RM, r"^\*\*当前观察项", 122),
    ("rm-cmp-row-locate", RM, r"^\| 定位 \| 模板匹配", 140),
    ("rm-cmp-row-measure", RM, r"^\| 测量 \| 卡尺", 141),
    ("rm-cmp-row-dl", RM, r"^\| 深度学习 \| 分类/检测", 144),
    ("rm-conclusion-line", RM, r"^\*\*结论（2026-09-24 复核更新）", 152),
    ("rm-gp2-1-3d", RM, r"^\| G-P2-1 \| 3D 视觉整体缺失", 204),
    ("rm-gp2-4-accel", RM, r"^\| G-P2-4 \| 推理加速", 207),
    ("rm-sec6-3d", RM, r"^1\. \*\*3D 视觉\*\*（G-P2-1）", 237),
    ("rm-sec6-accel", RM, r"^4\. \*\*推理加速\*\*（G-P2-4）", 240),
    ("rm-smoke-diag-note", RM, r"该文件取完数据后即删除", 267),
