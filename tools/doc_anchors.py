...
ANCHORS = [
    ...
    ("rm-cand-2-s7", RM, r"^\| ② \| \*\*G-P1-4", 95),
    ("rm-cand-3-i18n", RM, r"^\| ③ \| \*\*G-P1-5", 96),
    ("rm-cand-4-sdk", RM, r"^\| ④ \| G-P1-7", 97),
    ("rm-cand-5-mes", RM, r"^\| ⑤ \| G-P1-12", 98),
    ("rm-cand-dl-training", RM, r"^\| —— \| \*\*G-P1-3 DL", 99),
    ("rm-cand-p2-bundle", RM, r"^\| —— \| \*\*P2 全部", 100),
    ("rm-real4-heading", RM, r"^> ### .*「真机四项」定义", 102),
    ("rm-real4-unconfirmed", RM, r"定义提议，尚未由需求方确认", 104),
    ("rm-real4-row-camera", RM, r"^> \| 1 \| 相机真机联调", 108),
    ("rm-real4-row-plc", RM, r"^> \| 2 \| PLC 真机联动", 109),
    ("rm-real4-row-soak", RM, r"^> \| 3 \| 现场 7×24 长稳", 110),
    ("rm-real4-row-ac", RM, r"^> \| 4 \| AC1–AC8 现场验收", 111),
    ("rm-observation-item", RM, r"^\*\*当前观察项", 121),
    ("rm-cmp-row-locate", RM, r"^\| 定位 \| 模板匹配", 139),
    ("rm-cmp-row-measure", RM, r"^\| 测量 \| 卡尺", 140),
    ("rm-cmp-row-dl", RM, r"^\| 深度学习 \| 分类/检测", 143),
    ("rm-conclusion-line", RM, r"^\*\*结论（2026-09-24 复核更新）", 151),
    ("rm-gp2-1-3d", RM, r"^\| G-P2-1 \| 3D 视觉整体缺失", 203),
    ("rm-gp2-4-accel", RM, r"^\| G-P2-4 \| 推理加速", 206),
    ("rm-sec6-3d", RM, r"^1\. \*\*3D 视觉\*\*（G-P2-1）", 236),
    ("rm-sec6-accel", RM, r"^4\. \*\*推理加速\*\*（G-P2-4）", 239),
    ("rm-smoke-diag-note", RM, r"该文件取完数据后即删除", 266),
    ...
    ("srs-ac1-row", SRS, r"^\| AC1 \|", 653),
    ("srs-ac6-row", SRS, r"^\| AC6 \|", 658),
    ("srs-ac7-row", SRS, r"^\| AC7 \|", 659),
    ("srs-ac8-row", SRS, r"^\| AC8 \|", 660),
    ("srs-ac9-row", SRS, r"^\| AC9 \|", 661),
    ("srs-ac10-row", SRS, r"^\| AC10 \|", 662),
]
